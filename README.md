...
- **Tier 4b next** — `feature/tier-4b-revisi-mechanism` (C6 Jenis Belanja, C7 Sumber Dana, C8 LHR APIP, C9 Akun Minus) belum dimulai. Sequential per Decision N2 dengan same pattern (Phase 1 types reuse + Phase 2a fixture + Phase 2b validators + Phase 3 UI grid expansion).
